...
// lib/src/widgets/empty_country_feed_widget.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:qr_flutter/qr_flutter.dart';
import '../services/location_service.dart';

class EmptyCountryFeedWidget extends StatelessWidget {
  final VoidCallback? onSwitchToGlobal;
  
  const EmptyCountryFeedWidget({Key? key, this.onSwitchToGlobal}) : super(key: key);
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text(
                'Be the first to ask a question addressed to $countryName.',
              ...
              SizedBox(height: 24),
              Text(
                'Share this QR code to help others from $countryName join the conversation.',
